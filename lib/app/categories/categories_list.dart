          ...
          if (widget.mode != CategoriesListMode.modalSelectMultiCategory) {
            ...
            return CheckboxListTile(
                ...
                secondary: category.icon.displayFilled(
                  size: 25,
                  color: ColorHex.get(category.color),
                ),
                value:
    ...
    if (isNowSelected == true) {
      ...
      selectedCategories.removeWhere(
        (element) =>
            ...
            element.parentCategoryID == category.id,
      );
    }
  }
          ...
          return Column(
            ...
            children: [
              ...
              TabBar(
                  ...
                  tabs: [
                    Tab(
                      text: t.transaction.types.income(n: 10),
                    ),
                    Tab(
                      text: t.transaction.types.expense(n: 10),
                    ),
                  ]),
              Expanded(
                child: Stack(
              ...
              if (widget.mode == CategoriesListMode.modalSelectMultiCategory)
                BottomSheetFooter(
                  onSaved: selectedCategories.isNotEmpty
                      ? () {
                          return Navigator.of(context).pop(selectedCategories);
                        }
                      : null,
                ),
            ],
